#ifndef CRunRecordLastMonthPage_H
#define CRunRecordLastMonthPage_H
...
class CRunRecordLastMonthPage : public CPage
{
    DECLEAR_MESSAGE_MAP(CRunRecordLastMonthPage)
public:
    CRunRecordLastMonthPage();
...
#endif // CRunRecordLastMonthPage_H
