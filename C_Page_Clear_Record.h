...
#define ID_PIBCR_BUTTON_REENERGY      0x0017
#define ID_PIBCR_LABEL_REDTIME3       0x0018
...
protected:
    ...
    void UpdateReEnergyBtn(int id, int colorVal);
    ...
    void SetRun_Record_LabelString_long4(int id, unsigned long DataVal);
    void SetRun_Record_LabelString_long3(int id, unsigned long DataVal);
