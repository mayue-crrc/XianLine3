...
#define ID_PICMAINTAIN_BUTTON_ENERGYCOUNTSETTING 0x0015

#define ID_PICMAINTAIN_BUTTON_PCERESTART 0x0016
#define ID_PICMAINTAIN_BUTTON_LUMSET    0x0017

#define ID_PICMAINTAIN_BUTTON_BROADCASTSTATION 0x0018
#define ID_PICMAINTAIN_BUTTON_SETSTATION    0x0019
#define ID_PICMAINTAIN_BUTTON_MEASUREDISTANCE   0x001A
#define ID_PICMAINTAIN_BUTTON_SETBROADCASTSTATION  0X001B
...
protected:
   ...
   void  OnAW0TestCLK();
   void  OnDisEBTestCLK();
   void  OnEnergyCountCLK();
   void  OnPCERestartCLK();
   void  OnLumSetCLK();
   void  OnBroadcaststationCLK();
   void  OnSetstationCLK();
   void  OnmeasuredistanceCLK();
   void OnBroadcastStationClk();
};
