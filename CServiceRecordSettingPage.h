#ifndef CSERVICERECORDSETTINGPAGE_H
#define CSERVICERECORDSETTINGPAGE_H
...
class CServiceRecordSettingPage : public CPage
{
    DECLEAR_MESSAGE_MAP(CServiceRecordSettingPage)
public:
    CServiceRecordSettingPage();
...
#endif // CSERVICERECORDSETTINGPAGE_H
