#ifndef C_Page_Station_Cancel_H
#define C_Page_Station_Cancel_H
...
#define    ID_PIBSTATIONCANCEL_LABEL_L1 0X0033
#define    ID_PIBSTATIONCANCEL_LABEL_L2 0X0034
...
class C_Page_Station_Cancel : public CPage
{
    DECLEAR_MESSAGE_MAP(C_Page_Station_Cancel)
public:
    C_Page_Station_Cancel();
