...
ROMDATA g_PicRom_TimeSetting[] =
{
    ...
    {QObject::trUtf8("ERM1时间"),           D_FONT_BOLD(6),      QRect(460,  110,  80, 30),          Qt::white,                 Qt::black,                CONTROL_LABEL,           ID_IGNORE       },
    {QObject::trUtf8("ERM2时间"),           D_FONT_BOLD(6),      QRect(460,  150,  80, 30),          Qt::white,                 Qt::black,                CONTROL_LABEL,           ID_IGNORE       },

    {"2010/07/10",              D_FONT(6),           QRect(540,  50+20, 100, 30),          Qt::white,                 Qt::black,               CONTROL_LABEL,           ID_PIBTIMESETTING_LABEL_CCUDATE         },
    {"2010/07/10",              D_FONT(6),           QRect(540,  110, 100, 30),          Qt::white,                 Qt::black,               CONTROL_LABEL,           ID_PIBTIMESETTING_LABEL_ERM1DATE         },
    {"2010/07/10",              D_FONT(6),           QRect(540,  150, 100, 30),          Qt::white,                 Qt::black,               CONTROL_LABEL,           ID_PIBTIMESETTING_LABEL_ERM2DATE         },

    {"00:00:00",                D_FONT(6),           QRect(650,  50+20,  90, 30),          Qt::white,                 Qt::black,               CONTROL_LABEL,           ID_PIBTIMESETTING_LABEL_CCUTIME         },
    {"00:00:00",                D_FONT(6),           QRect(650,  110,  90, 30),          Qt::white,                 Qt::black,               CONTROL_LABEL,           ID_PIBTIMESETTING_LABEL_ERM1TIME         },
    {"00:00:00",                D_FONT(6),           QRect(650,  150,  90, 30),          Qt::white,                 Qt::black,               CONTROL_LABEL,           ID_PIBTIMESETTING_LABEL_ERM2TIME         },
    ...
    //{"60",                      D_FONT(6),           QRect(410,  50+20,  40, 30),           Qt::white,                Qt::black,               CONTROL_LABEL,            ID_PIBTIMESETTING_LABEL_ATCTIMEFLG1    },
    //{"60",                      D_FONT(6),           QRect(410,  90,  40, 30),           Qt::white,                Qt::black,                CONTROL_LABEL,           ID_PIBTIMESETTING_LABEL_ATCTIMEFLG2    },
    {QObject::trUtf8(""),                  D_FONT_BOLD(8),      QRect(120, 135+60,  80, 40),           Qt::white,                Qt::black,                CONTROL_EDIT,            ID_PIBTIMESETTING_EDIT_YEAR            },
    {QObject::trUtf8(""),                  D_FONT_BOLD(8),      QRect(255, 135+60,  80, 40),           Qt::white,                Qt::black,                CONTROL_EDIT,            ID_PIBTIMESETTING_EDIT_MONTH           },
    {QObject::trUtf8(""),                  D_FONT_BOLD(8),      QRect(390, 135+60,  80, 40),           Qt::white,                Qt::black,                CONTROL_EDIT,            ID_PIBTIMESETTING_EDIT_DAY             },
    {QObject::trUtf8("年"),                D_FONT_BOLD(9),      QRect(205, 135+60,  20, 40),           Qt::white,                Qt::black,                CONTROL_LABEL,           ID_IGNORE       },
    {QObject::trUtf8("月"),                D_FONT_BOLD(9),      QRect(340, 135+60,  20, 40),           Qt::white,                Qt::black,                CONTROL_LABEL,           ID_IGNORE       },
    {QObject::trUtf8("日"),                D_FONT_BOLD(9),      QRect(475, 135+60,  20, 40),           Qt::white,                Qt::black,                CONTROL_LABEL,           ID_IGNORE       },
    {QObject::trUtf8(""),                  D_FONT_BOLD(8),      QRect(120, 245+60,  80, 40),           Qt::white,                Qt::black,                CONTROL_EDIT,            ID_PIBTIMESETTING_EDIT_HOUR            },
    {QObject::trUtf8(""),                  D_FONT_BOLD(8),      QRect(255, 245+60,  80, 40),           Qt::white,                Qt::black,                CONTROL_EDIT,            ID_PIBTIMESETTING_EDIT_MINUTE          },
    {QObject::trUtf8(""),                  D_FONT_BOLD(8),      QRect(390, 245+60,  80, 40),           Qt::white,                Qt::black,                CONTROL_EDIT,            ID_PIBTIMESETTING_EDIT_SECOND          },
    {QObject::trUtf8("时"),                D_FONT_BOLD(9),      QRect(205, 245+60,  20, 40),           Qt::white,                Qt::black,                CONTROL_LABEL,           ID_IGNORE       },
    {QObject::trUtf8("分"),                D_FONT_BOLD(9),      QRect(340, 245+60,  20, 40),           Qt::white,                Qt::black,                CONTROL_LABEL,           ID_IGNORE       },
    {QObject::trUtf8("秒"),                D_FONT_BOLD(9),      QRect(475, 245+60,  20, 40),           Qt::white,                Qt::black,                CONTROL_LABEL,           ID_IGNORE       },
    {QObject::trUtf8("7"),                 D_FONT_BOLD(8),      QRect(535, 135+60,  60, 60),           Qt::black,                Qt::gray,                CONTROL_BUTTON,           ID_PIBTIMESETTING_BUTTON_7             },
    {QObject::trUtf8("8"),                 D_FONT_BOLD(8),      QRect(605, 135+60,  60, 60),           Qt::black,                Qt::gray,                CONTROL_BUTTON,           ID_PIBTIMESETTING_BUTTON_8             },
    {QObject::trUtf8("9"),                 D_FONT_BOLD(8),      QRect(675, 135+60,  60, 60),           Qt::black,                Qt::gray,                CONTROL_BUTTON,           ID_PIBTIMESETTING_BUTTON_9             },
    {QObject::trUtf8("4"),                 D_FONT_BOLD(8),      QRect(535, 205+60,  60, 60),           Qt::black,                Qt::gray,                CONTROL_BUTTON,           ID_PIBTIMESETTING_BUTTON_4             },
    {QObject::trUtf8("5"),                 D_FONT_BOLD(8),      QRect(605, 205+60,  60, 60),           Qt::black,                Qt::gray,                CONTROL_BUTTON,           ID_PIBTIMESETTING_BUTTON_5             },
    {QObject::trUtf8("6"),                 D_FONT_BOLD(8),      QRect(675, 205+60,  60, 60),           Qt::black,                Qt::gray,                CONTROL_BUTTON,           ID_PIBTIMESETTING_BUTTON_6             },
    {QObject::trUtf8("1"),                 D_FONT_BOLD(8),      QRect(535, 275+60,  60, 60),           Qt::black,                Qt::gray,                CONTROL_BUTTON,           ID_PIBTIMESETTING_BUTTON_1             },
    {QObject::trUtf8("2"),                 D_FONT_BOLD(8),      QRect(605, 275+60,  60, 60),           Qt::black,                Qt::gray,                CONTROL_BUTTON,           ID_PIBTIMESETTING_BUTTON_2             },
    {QObject::trUtf8("3"),                 D_FONT_BOLD(8),      QRect(675, 275+60,  60, 60),           Qt::black,                Qt::gray,                CONTROL_BUTTON,           ID_PIBTIMESETTING_BUTTON_3             },
    {QObject::trUtf8("0"),                 D_FONT_BOLD(8),      QRect(535, 345+60,  60, 60),           Qt::black,                Qt::gray,                CONTROL_BUTTON,           ID_PIBTIMESETTING_BUTTON_0             },
    {QObject::trUtf8("启动"),              D_FONT_BOLD(8),      QRect( 25, 500, 100, 38),           Qt::black,                Qt::gray,                CONTROL_BUTTON,           ID_PIBTIMESETTING_BUTTON_START          },
    {QObject::trUtf8("清空"),              D_FONT_BOLD(8),      QRect(535, 452+30, 100, 38),           Qt::black,                Qt::gray,                CONTROL_BUTTON,           ID_PIBTIMESETTING_BUTTON_CLEAR          },
    {QObject::trUtf8("确认"),              D_FONT_BOLD(8),      QRect(645, 452+30, 100, 38),           Qt::black,                Qt::gray,                CONTROL_BUTTON,           ID_PIBTIMESETTING_BUTTON_CONFIRM        },
    ...
    {QObject::trUtf8("确认无误，按【启动】键启动时钟。"),      D_FONT_BOLD(8),      QRect( 25, 460,  320, 38),        Qt::white, Qt::black,                CONTROL_LABEL,           ID_PIBTIMESETTING_LABEL2       },
...
{  
    ...
    ccu_date = StrFromInt( 2000+PUBPORT_SysTimeYear_U8, 10 )+"/"+StrFromInt( PUBPORT_SysTimeMonth_U8, 10 )+"/"+StrFromInt( PUBPORT_SysTimeDay_U8, 10 );
...
void CTimeSettingPage::UpdateCCUTime()
{
    ...
    ccu_time = StrFromInt(PUBPORT_SysTimeHour_U8, 10 )+":"+StrFromInt( PUBPORT_SysTimeMinute_U8, 10 )+":"+StrFromInt(PUBPORT_SysTimeSecond_U8, 10 );
    ((CLabel *)GetDlgItem(ID_PIBTIMESETTING_LABEL_CCUTIME))->SetCtrlText(ccu_time);

}

void CTimeSettingPage::UpdateATCDate()//ERM的时间
{
    QString erm1_date = "";
    QString erm2_date = "";
    erm1_date = StrFromInt( 2000+DT1CT_ERMTimeYear , 10 )+"/"+StrFromInt( DT1CT_ERMTimeMonth , 10 )+"/"+StrFromInt(DT1CT_ERMTimeDay , 10 );
    erm2_date = StrFromInt( 2000+DT2CT_ERMTimeYear , 10 )+"/"+StrFromInt( DT2CT_ERMTimeMonth , 10 )+"/"+StrFromInt(DT2CT_ERMTimeDay , 10 );
    ((CLabel *)GetDlgItem(ID_PIBTIMESETTING_LABEL_ERM1DATE))->SetCtrlText(erm1_date);
    ((CLabel *)GetDlgItem(ID_PIBTIMESETTING_LABEL_ERM2DATE))->SetCtrlText(erm2_date);

}

void CTimeSettingPage::UpdateATCTime()//ERM的时间
{
    QString erm1_time = "00:00:00";
    QString erm2_time = "00:00:00";
    erm1_time = StrFromInt(DT1CT_ERMTimeHour, 10 )+":"+StrFromInt( DT1CT_ERMTimeMinte , 10 )+":"+StrFromInt(DT1CT_ERMTimeSecond , 10 );
    erm2_time = StrFromInt(DT2CT_ERMTimeHour , 10 )+":"+StrFromInt( DT2CT_ERMTimeMinte , 10 )+":"+StrFromInt(DT2CT_ERMTimeSecond , 10 );
    ((CLabel *)GetDlgItem(ID_PIBTIMESETTING_LABEL_ERM1TIME))->SetCtrlText(erm1_time);
    ((CLabel *)GetDlgItem(ID_PIBTIMESETTING_LABEL_ERM2TIME))->SetCtrlText(erm2_time);
}
