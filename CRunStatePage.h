...
#define ID_PIBRUNSTATE_LABEL_ATCMODE                       0X0004
...
#define ID_PIBRUNSTATE_LABEL_CAR2HSCBSTATE           0X00C9
#define ID_PIBRUNSTATE_LABEL_CAR3HSCBSTATE           0X00CA
#define ID_PIBRUNSTATE_LABEL_CAR4HSCBSTATE           0X00CB
#define ID_PIBRUNSTATE_LABEL_CAR5HSCBSTATE           0X00CC

#define ID_PIBRUNSTATE_LABEL_ATBMODE                 0X00CD
#define ID_PIBRUNSTATE_LABEL_BACKMODE                0X00CF
#define ID_PIBRUNSTATE_LABEL_CAR1TRACTIONENABLE      0X00D0
#define ID_PIBRUNSTATE_LABEL_CAR6TRACTIONENABLE      0X00D1

#define ID_PIBRUNSTATE_BUTTON_BACKUPMODE            0X00D2  ///ADD BACKUP

#define ID_PIBRUNSTATE_BUTTON_SETBROADCASTSTATION   0x00d3

#define ID_PIBRUNSTATE_LABEL_LEVELVALUE               0X00D4
#define ID_PIBRUNSTATE_LABEL_SPEEDVALUE               0X00D5
#define ID_PIBRUNSTATE_LABEL_LEVELBAR               0X00D6
#define ID_PIBRUNSTATE_LABEL_SPEEDBAR               0X00D7
...
private:
    ...
    void UpdateHSCBState();
    void SetHSCBStatusLabelColor(int id,int colorVal);
    void UpdateTractionEnable();
    bool AllCarrealse;
    void OnBroadcastStationClk();
