                               ...
                               )
{
    ...
    if (nBtnState == LBUTTON_DOWN)
    {
        if(m_btnType == BUTTON_BLKSCREEN)
        {
            QRect rect;
            m_pPainter->fillRect(insideRect,Qt::black);
    ...
    else
    {
        ...
        {
                m_pPainter->fillRect(insideRect,Qt::darkGray);
            ...
            if (m_btnType == BUTTON_STATION1) //normal
        {
            ...
            if (m_btnType == BUTTON_BLKSCREEN) //normal
        {
                m_pPainter->fillRect(insideRect,Qt::black);
...
void CButton::DrawButton(__in int ntype)
{
    ...
    case BUTTON_BLKSCREEN://blackscreen
    {
        if (m_bIsEnable == true)
        {
             ChangeButtonState(LBUTTON_UP);
